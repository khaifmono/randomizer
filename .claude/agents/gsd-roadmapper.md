...
Reference full template: `/Users/khaif/Documents/code-repo/base-project/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/khaif/Documents/code-repo/base-project/.claude/get-shit-done/templates/state.md`.
