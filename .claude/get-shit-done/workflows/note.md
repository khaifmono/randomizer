...
- **Global scope**: `/Users/khaif/Documents/code-repo/base-project/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/khaif/Documents/code-repo/base-project/.claude/notes/`)
...
2. Glob `/Users/khaif/Documents/code-repo/base-project/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/khaif/Documents/code-repo/base-project/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/khaif/Documents/code-repo/base-project/.claude/notes/` — works in any directory
