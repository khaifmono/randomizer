...
<!-- For checkpoint task examples and patterns, see @/Users/khaif/Documents/code-repo/base-project/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Users/khaif/Documents/code-repo/base-project/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/khaif/Documents/code-repo/base-project/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/khaif/Documents/code-repo/base-project/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
